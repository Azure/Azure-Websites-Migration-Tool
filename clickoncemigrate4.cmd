...
set PublishingLocation=https://migrate4.azurewebsites.net
set SupportURL=https://migrate4.azurewebsites.net
set Tools="C:\Program Files (x86)\Microsoft SDKs\Windows\v8.0A\bin\NETFX 4.0 Tools"
set Mage=%Tools%\mage.exe
set CertPath="CompatCheckAndMigrate_TemporaryKey.pfx"
set CertPwd=""
